...
/**
 * The polling response to a urldebugger request.
 * 
 */
...
public class UrlDebugPostResponse {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UrlDebugPostResponse) == false) {
            return false;
        }
        UrlDebugPostResponse rhs = ((UrlDebugPostResponse) other);
