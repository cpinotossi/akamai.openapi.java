...
@RunWith(Suite.class)
@SuiteClasses({OpenCLITestMkdir.class, OpenCLITestUpload.class, OpenCLITestDir.class, OpenCLITestDirRecursive.class, OpenCLITestDeleteFile.class, OpenCLITestDeleteFolder.class})

public class OpenCLITestSuite {
